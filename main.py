from tkinter import END, TOP, X, Button, Entry, Frame, Label, StringVar, Text, Tk, font, messagebox, ttk
...
lbldoj = Label(entries_frame, text="D.O.J", font=(
    "Calibri", 16), bg="#535c68", fg="white")
...
lblContact = Label(entries_frame, text="Contact No",
                   font=("Calibri", 16), bg="#535c68", fg="white")
...
style.configure("mystyle.Treeview", font=("Calibri", 18),
                rowheight=50)  # Mofify the font of the body
